...
public class CoreDataStore {
    ...
    public init(model: Model, dispatchQueue: DispatchQueue = .main, persisted: Bool = true) throws {
        persistentContainer = try NSPersistentContainer(model: model, persisted: persisted)
