...
class Model_2_0_3: NSManagedObjectModel {
    
    public static var instance: Model_2_0_3 = Model_2_0_3()
    ...
    private override init() {
        ...
        device.properties.append(NSAttributeDescription(name: "retina", type: .booleanAttributeType))
        ...
        integration.properties.append(NSAttributeDescription(name: "testHierachy", type: .transformableAttributeType))
        integration.properties.append(NSAttributeDescription(name: "testHierachyData", type: .binaryDataAttributeType))
