public typealias XCSProxiedDeviceDocument = XCSProxiedDevice

/// A device that is paired with another `XCSDevice`.
public struct XCSProxiedDevice: Codable {
...
// MARK: - Identifiable
extension XCSProxiedDevice: Identifiable {
...
// MARK: - Equatable
extension XCSProxiedDevice: Equatable {
}

// MARK: - Hashable
extension XCSProxiedDevice: Hashable {
}
