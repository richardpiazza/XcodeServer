...
final class XcodeServerTests: XCTestCase {
    ...
    func testModel_1_0_0_Hashes() {
        ...
        XCTAssertEqual(entityHashes[Device.entityName]!.hexString, "fbd59b361b36bcb0527ba10fbc17025071658779c17065303590c6a743d45874")
        ...
        XCTAssertEqual(entityHashes[Integration.entityName]!.hexString, "842a0d1e86b935a442e80c92d8cd6cf666fdbca8384a354dea3d142b56198bca")
        ...
        XCTAssertEqual(entityHashes[Issue.entityName]!.hexString, "def3423baec39ba02877bf52d3090cd5b6e52e087706e3115720007e5c5f3591")
        XCTAssertEqual(entityHashes[Platform.entityName]!.hexString, "97956d5d10b1f7afa1d97ea9da5e965adbb4e10aa2fd2718b5518306aa8ac419")
